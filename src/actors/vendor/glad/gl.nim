{.used.}
#[
    OpenGL loader generated by glad 0.1.33 on Wed May 27 21:11:48 2020.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="nim" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=core&language=nim&specification=gl&loader=on&api=gl%3D4.6
]#
...
proc hasExt(extname: string): bool {.used.} =
  if extname.len == 0:
    return false
