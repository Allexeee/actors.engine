...
when not defined(cpp) or defined(cimguiDLL):
  ...
  {.pragma: imgui_header, header: currentSourceDir() & "/ncimgui.h".}
...
proc newImVec2ih*(rhs: ImVec2): ptr ImVec2ih {.importc: "ImVec2ih_ImVec2ihVec2".}
